...
def gas_predict():
    ...
    # # Full diesel List
    # df_volk = df_combo_slim[df_combo_slim['model'].isin(['AUDI A3', 'AUDI A6', \
    #          'AUDI A7', 'AUDI A8 L', 'AUDI Q5', 'AUDI Q7', 'BMW 328d', \
    #          'BMW 328d Sports Wagon', 'BMW 535d', 'BMW 740Ld', \
    ...
    # Uncomment for specific volks cars
...
def maker_diff():
  ...
  df_audi = df_makers[df_makers['model'].isin([
      ...
      'AUDI Q5', 'AUDI Q5 Hybrid', 'AUDI Q7'])]
  df_bmw = df_makers[df_makers['model'].isin([
         'BMW 328i', \
         'BMW 328i Gran Turismo', 'BMW 328i Sports Wagon', 'BMW 535i', \
         'BMW 535i Gran Turismo', 'BMW 740Li', 'BMW 740i', 'BMW X3 sDrive28i', \
         'BMW X3 xDrive28i', 'BMW X5', 'BMW X5 M'])]
